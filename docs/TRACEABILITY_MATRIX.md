...
| SRS-F-04 | TX событий клавиш | `include/uart_protocol.h`, `src/app_runtime.c` | `tests/test_app_runtime.c` | Covered |
| SRS-F-05 / SRSw-TX-* | Keepalive и pacing | `src/core/tx_scheduler.c`, `src/app_runtime.c` | `tests/test_tx_scheduler.c`, `tests/test_app_runtime.c` | Covered |
| SRS-F-06 / SRSw-RX-* | RX LED команды | `src/core/rx_decoder.c`, `src/platform/avr/hal_avr.c`, `src/app_runtime.c` | `tests/test_rx_decoder.c` | Covered |
